...
import com.imgur.api.ImgurUploadTask;
...
public class CameraView extends Activity implements SurfaceHolder.Callback,
	...
	public void onCreate(Bundle icicle) {
        ...
        CameraView.context = getApplicationContext();
		Log.e(TAG, "onCreate");
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			if(data != null) {
				...
				try {
					...
					onDoneTakingPicture(Uri.fromFile(f));
	...
	public void onDoneTakingPicture(Uri imageUri){
        //
        new MyImgurUploadTask(imageUri,CameraView.this).execute();
	}
    ...
    private class MyImgurUploadTask extends ImgurUploadTask {
        ...
        protected void onPostExecute(String imageId) {
            ...
            Log.i(TAG,"Image URL:"+mImgurUrl);
            try {
                PrintWriter out = new PrintWriter(Environment.getExternalStorageDirectory() + File.separator + "imgur.txt");
                out.print(mImgurUrl);
                out.close();
            } catch (Exception e){
                e.printStackTrace();;
